...
EC2 is used to test S3 access and upload/download files from the team sharing bucket. The website itself does not run from EC2 because it is only static HTML.
